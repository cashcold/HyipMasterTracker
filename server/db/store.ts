...
class Store {
    ...
    const projects: IProject[] = [
      {
        ...
        websiteUrl: 'https://prime-gold-resources.vercel.app',
        ...
        description:
          'Advertised as a registered, regulated cryptocurrency cloud mining and algorithmic investment firm headquartered in the UK. Features high-yield automated daily plans backed by liquid-cooled ASIC S21 Pro hardware, 100% principal capital return guarantee, instant payouts under 10 minutes, and a $5 welcome bonus upon registration.',
        country: 'United Kingdom',
        category: 'Crypto Cloud Mining & ROI Platform',
        status: 'PAYING',
        riskScore: 8.5,
        riskLevel: 'Good',
        rating: 9.1,
        ...
        withdrawalMethods: 'Instant (Avg < 10 Minutes)',
        plans: [
          {
            id: 'plan-pgr-1',
            name: 'Starter Plan',
        ...
        monitorStatuses: [
          {
            ...
            monitorLogo: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=100&auto=format&fit=crop&q=80',
            status: 'PAYING',
            rating: 9.1,
            notes: 'Verified instant USDT TRC20 and ETH cloud mining settlement payouts.',
          ...
          },
          {
            ...
            monitorLogo: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=100&auto=format&fit=crop&q=80',
            status: 'PAYING',
            rating: 9.0,
            notes: 'Automated instant payouts verified under 10 minutes across all crypto networks.',
            reportedAt: '2026-08-31T00:00:00.000Z',
          },
        ],
        isFeatured: true,
      ...
      },
      {
        ...
        websiteUrl: 'https://aura-diamond-holdings.vercel.app',
        logo: 'https://images.unsplash.com/photo-1610375461246-83df859d849d?w=600&auto=format&fit=crop&q=80',
        screenshot: 'https://images.unsplash.com/photo-1642543492481-44e81e3914a7?w=1000&auto=format&fit=crop&q=80',
        description:
          'Advertised as a premier physical diamond asset manager and cryptographic custody enterprise registered in the UK. Features high-yield automated daily plans backed by physical gem reserves, 100% principal capital return guarantee, instant payouts under 10 minutes, and a $5 signup bonus.',
        country: 'United Kingdom',
        category: 'Precious Commodities & Investment',
        status: 'PAYING',
        riskScore: 8.5,
        riskLevel: 'Good',
        rating: 9.1,
        ...
        monitorStatuses: [
          {
            ...
            status: 'PAYING',
            rating: 9.0,
            notes: 'Verified instant USDT TRC20 and ETH settlement payouts.',
            reportedAt: '2026-08-26T19:26:27.000Z',
          },
          {
            id: 'mr-adh-2',
            monitorId: 'mon-2',
            ...
            status: 'PAYING',
            rating: 8.9,
            notes: 'Automated payouts verified across all supported crypto gateways.',
            reportedAt: '2026-08-26T19:26:27.000Z',
          },
        ],
        isFeatured: true,
        ...
        updatedAt: '2026-08-26T19:26:27.000Z',
      },
      {
        id: 'proj-goldbod-pro',
        name: 'GoldBod Pro',
        ...
        riskLevel: 'Good',
        rating: 8.9,
        dateAdded: '2026-08-31T00:00:00.000Z',
  ...
  monitorStatuses: [
    ...
    const events: IEvent[] = [
      {
        id: 'evt-1',
        projectId: 'proj-prime-gold',
        projectName: 'Prime Gold Resources',
        projectSlug: 'prime-gold-resources',
        type: 'PAYMENT_REPORTED',
        oldStatus: 'PAYING',
        newStatus: 'PAYING',
        message: 'Instant automated payouts verified on USDT TRC20 and Ethereum cloud mining payouts.',
        monitorId: 'mon-1',
        monitorName: 'GoldPoll Monitor',
      ...
      {
        id: 'evt-2',
        projectId: 'proj-aura-diamond',
        projectName: 'Aura Diamond Holdings',
        projectSlug: 'aura-diamond-holdings',
        type: 'PAYMENT_REPORTED',
        oldStatus: 'PAYING',
        newStatus: 'PAYING',
        message: 'Live test payout #118 verified on-chain and disbursed instantly to monitoring wallet.',
        monitorId: 'mon-2',
        monitorName: 'InvestScan Radar',
      ...
      {
        id: 'evt-3',
        projectId: 'proj-goldbod-pro',
        projectName: 'GoldBod Pro',
        projectSlug: 'goldbod-pro',
        type: 'PAYMENT_REPORTED',
        oldStatus: 'PAYING',
        newStatus: 'PAYING',
        message: 'Daily profit distribution confirmed with fast multi-signature withdrawal settlement.',
        monitorId: 'mon-4',
        monitorName: 'CryptoAudit Watch',
      ...
      {
        id: 'evt-4',
        projectId: 'proj-cloudminex',
        projectName: 'CloudMineX',
        projectSlug: 'cloudminex',
        type: 'PAYMENT_REPORTED',
        oldStatus: 'PAYING',
        newStatus: 'PAYING',
        message: 'Fast payout verified with stable transaction outflow across all monitoring nodes.',
        monitorId: 'mon-3',
        monitorName: 'HyipHome',
      ...
      },
      {
        ...
        oldStatus: 'PAYING',
        newStatus: 'PAYING',
        message: 'Batch withdrawal payout #45 verified under 10 minutes.',
        monitorId: 'mon-2',
        monitorName: 'InvestScan Radar',
